...
export default function InfluencerRegistration() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Failed to register influencer');
    } finally {
      setIsLoading(false);
    }
  };
            ...
            <div className="relative bg-black/50 backdrop-blur-sm border border-white/10 rounded-xl p-12">
              <div className="space-y-8">
                <div className="text-center">
                  <h1 className="text-4xl font-bold text-white mb-2">Influencer Registration</h1>
                  <p className="text-gray-400 text-lg">Join the TikStar influencer network</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  >
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-brand-pink to-brand-pink rounded-lg blur opacity-60 group-hover:opacity-100 transition"></div>
